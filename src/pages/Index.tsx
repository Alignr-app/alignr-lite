...
const Index: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-white to-gray-100">
      ...
      {/* Preview Overlay */}
      <PreviewOverlay overlayClass={`overlay-${activeVisualCue}`} active={previewActive} />
      ...
      <div className="flex-1 container max-w-md px-4 py-8 flex flex-col gap-6">
        <div className="text-center space-y-3">
          <h1 className="text-3xl font-semibold text-gray-800">Alignr</h1>
        ...
        <div className="grid gap-4">
          <Card className="p-6 text-center shadow-md hover:shadow-lg transition-shadow glassmorphism">
          ...
          <Card className="p-6 text-center shadow-md hover:shadow-lg transition-shadow glassmorphism">
            <h2 className="text-xl font-semibold mb-4">Schedule Your Mindfulness</h2>
            <p className="text-gray-600 mb-6">
